   ...
   <body>
      <div class="container">
            ...
            <div class="container-fluid">
               ...
               <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav">
                     <li ><a href="/shek/default.php">Home</a></li>
                     <li class="active"><a href="/shek/about.php">About<span class="sr-only">(current)</span></a></li>
                     <li class="dropdown">
         ...
         <div class="jumbotron">
            <div class="container">
               <h1>About</h1>
               <p>ArtMart muthafuckas! And you are viewing this on <?php echo date("Y-m-d") ?>.</p>
            </div>
         </div>
         <footer class="footer">
            <div class="container">
